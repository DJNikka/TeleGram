...
class CameraViewController: UIViewController, AVCaptureFileOutputRecordingDelegate {
	...
	private func configureSession() {
		...
		*/
		...
		do {
            ...
            } else if let backCameraDevice = AVCaptureDevice.default(for: AVMediaType.video) {
				// If the back dual camera is not available, default to the back wide angle camera.
				defaultVideoDevice = backCameraDevice
            } else if let frontCameraDevice = AVCaptureDevice.default(for: AVMediaType.video) {
				/*
    ...
    private let videoDeviceDiscoverySession = AVCaptureDevice.DiscoverySession(__deviceTypes: [.builtInWideAngleCamera, .builtInDualCamera],
